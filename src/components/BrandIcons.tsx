...
export function LeetcodeIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg
      ...
      fill="currentColor"
    >
      <path d="M13.483 0a1.374 1.374 0 0 0-.961.438L7.116 6.226l-3.854 4.126a5.266 5.266 0 0 0-1.209 2.104 5.35 5.35 0 0 0-.125.513 5.527 5.527 0 0 0 .062 2.362 5.83 5.83 0 0 0 .349 1.017 5.938 5.938 0 0 0 1.271 1.818l4.277 4.193.039.038c2.248 2.165 5.852 2.133 8.063-.074l2.396-2.392c.54-.54.54-1.414.003-1.955a1.378 1.378 0 0 0-1.951-.003l-2.396 2.392a3.021 3.021 0 0 1-4.205.038l-.02-.019-4.276-4.193c-.652-.64-.972-1.469-.948-2.263a2.68 2.68 0 0 1 .666-1.607 2.66 2.66 0 0 1 .388-.392l4.255-4.547 4.417-4.634a1.374 1.374 0 0 0-.961-2.327h-.002z" />
      <path d="M20.311 8.878H9.37a1.38 1.38 0 1 0 0 2.76h10.941a1.38 1.38 0 1 0 0-2.76z" />
    </svg>
  );
}
